            ...
            try {
              ...
              if($result->state != "approved") {
               ...
               /* echo "<br> el detalle es ".$detalleCompraPaypal;
                ...
                //header("Location:../resultado.php?estado=true&metodoPago=PayPal");//
                echo '<script>window.location ="../resultado.php?estado=true&metodoPago=PayPal"; </script>';//direcciono al penel de administracion del 
