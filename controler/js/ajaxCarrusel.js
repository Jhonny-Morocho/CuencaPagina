...
$(".editarImgCarrusel").on('click',function(e){
    e.preventDefault();
...
$(".eliminarImgCarrusel").on('click',function(e){
    e.preventDefault();
    //obtengo el id y lo escribo en el formulacio
    var idCarrusel=$(this).attr('data-id');
    var nombreArchivo=$(this).attr('data-nombreViejo');
        ...
        if (result.value) {
                ...
                $.ajax({
                    ...
                    data:{
                        ...
                        'Carrsuel':'eliminarImgCarrusel'

                    },
                        url:'../controler/ctrCarrusel.php',// mando al servidor con la opcion que sea(modelo_proveedor.php)
