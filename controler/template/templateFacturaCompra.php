...
class ClassPlantilla{
  ...
  public static function templateFactura($tipoPago,$productos,$datosCliente){
                ...
                <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 1px; border-top-color: #dddddd; border-top-style: solid; height: 1px; width: 100%; margin: 0;" align="left"></td>
                        ...
                        <p 
                            style="line-height: 
                                ...
                                16px; width: 100%; 
                                margin: 0;" 
                                align="left"><b>Cliente:</b>'.$datosCliente['nombre'].' '.$datosCliente['apellido'].'
                        </p>
                        ...
                        <p 
                            ...
                            '.$datosCliente['documentoIdentidad'].'
                        </p>
