...
<div class="row">  
    <div class="container terminosCondiciones mb-5" style="text-align: justify;">
        ...
        (iii) Está de acuerdo con el hecho de que no puede usar o descargar materiales de audio de EuropaRemix.com si está en conflicto con la legislación de su país.
         ...
         <OL class="mt-4">
             <LI >
                Definición del servicio de música Latinedit.com.
            </LI>
                <p>
                    Latin Edit es el proveedor del servicio de música Latinedit.com (el 'Servicio') que le permite comprar descargas de contenido digital, como grabaciones de sonido ('Productos'), 
                    bajo ciertos términos y condiciones establecidos en este Acuerdo.
                </p> 

            <LI class="mt-3">
                Requisitos de edad para el uso del Servicio.
            </LI>
                <p>
                    Este Servicio está disponible para personas mayores de 13 años. Si tiene 13 años o más pero menos de 18 años, debe revisar estos términos y condiciones con su
                    padre o tutor para asegurarse de que usted y su padre o tutor comprenden estos términos y condiciones.
            ...
            <p>
                El uso del Servicio requiere un dispositivo compatible, acceso a Internet (pueden aplicarse tarifas) y cierto software (pueden aplicarse tarifas),
                y puede requerir la obtención de actualizaciones o actualizaciones de vez en cuando. Debido a que el uso del Servicio implica hardware, software y acceso a Internet, 
                su capacidad para usar el Servicio puede verse afectada por el desempeño de estos factores. Se recomienda encarecidamente el acceso a Internet de alta velocidad. 
                Usted reconoce y acepta que dichos requisitos del sistema, que pueden cambiar de vez en cuando, son su responsabilidad. El Servicio no es parte de ningún otro producto u oferta, 
                y ninguna compra u obtención de ningún otro producto se interpretará como una representación o garantía de su acceso al Servicio.
            </p>
            ...
            <p>
                Usted acepta proporcionar la información precisa, actual y completa necesaria para registrarse en el Servicio y en otros puntos que puedan ser necesarios durante el uso del Servicio ("Datos de registro"). Además, acepta mantener y actualizar sus Datos de registro según sea necesario para mantenerlos precisos, actualizados y completos. Latín Edit puede rescindir sus derechos sobre cualquier parte o la totalidad del Servicio si la información que proporcione es falsa, inexacta o incompleta. Usted acepta que Latinedit.com puede almacenar y utilizar 
                los Datos de registro que proporciona para su uso en el mantenimiento de su cuenta y saldo.
            ...
            <p>
                Cuenta y Contraseña. Como usuario registrado del Servicio, puede establecer una cuenta ('Cuenta'). Usted es el único responsable de mantener la confidencialidad 
                y seguridad de su Cuenta. No debe revelar la información de su Cuenta a nadie más ni utilizar la Cuenta de otra persona. Usted es completamente responsable 
                de todas las actividades que ocurran en su Cuenta oa través de ella, y acepta notificar inmediatamente a Latinedit.com de cualquier uso no autorizado de su Cuenta 
                o cualquier otra violación de seguridad. Latín Edit no será responsable de las pérdidas que surjan del uso no autorizado de su Cuenta.
            </p>
            <p>
                Seguridad. Acepta no violar ni intentar violar ningún componente de seguridad del Servicio. Usted acepta no intentar, ni ayudar a otra persona a, eludir, 
                realizar ingeniería inversa, descompilar, desensamblar o alterar de cualquier otra forma el software y / o los componentes 
                del sitio web relacionados con el Servicio por ningún motivo ('Reglas de uso'). . Latinedit.com puede controlar y supervisar las Reglas de uso con fines de cumplimiento, 
                y Latín Edit se reserva el derecho de hacer cumplir las Reglas de uso con o sin previo aviso. No accederá al Servicio por ningún medio que no sea el software proporcionado
                por Latinedit.com para acceder al Servicio. No deberá acceder ni intentar acceder a una Cuenta a la que no esté autorizado a acceder. Usted acepta no modificar 
                el software de ninguna manera o forma, ni utilizar versiones modificadas del software, para cualquier propósito, incluida la obtención 
                de acceso no autorizado al Servicio. Las violaciones de la seguridad del sistema o la red pueden resultar en responsabilidad civil o penal.
            </p>
            ...
            <p>
            Latín Edit y el servicio de música latinedit.com proporcionan Servicios con cargo. Usted paga por el Servicio antes de que se brinde el Servicio (pago anticipado) de acuerdo con las 
            reglas y tarifas.
             </p>

             <LI class="mt-3">
                 Compra de contenido del servicio de música Latinedit.com.
             </LI>
            <p>
                Usted reconoce que el uso de los Productos puede requerir el uso de otros productos de hardware y software (por ejemplo, 
                la capacidad de realizar copias de los Productos en medios físicos) y que dicho hardware y software es su responsabilidad.
                Una vez que se compra un Producto y usted recibe el Producto, es su responsabilidad no perder, destruir o dañar el Producto, y Latinedit.com no tendrá 
                responsabilidad ante usted en caso de pérdida, destrucción o daño.
            </p>
            ...
            <p>
                Todas las ventas son finales. No se proporcionan reembolsos de ningún tipo. Además, en caso de cancelación o suspensión de su cuenta, daño, destrucción o pérdida de sus Productos, 
                no se aplicarán reembolsos.
            </p>
