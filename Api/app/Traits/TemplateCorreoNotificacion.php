...
trait TemplateCorreoNotificacion {
          ...
          $precioUnitario=sprintf("%.2f", $precioUnitario);
                ...
                <td
                  ...
                  <td
                      ...
                      <a download
                          href="https://www.latinedit.com/adminCliente.php">
                        Descargar
                      </a>
                  </td>
              </tr>';
          ...
          <body style="outline: 0; width: 100%; min-width: 100%; height: 100%; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; font-family: Helvetica, Arial, sans-serif; line-height: 24px; font-weight: normal; font-size: 16px; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; box-sizing: border-box; color: #000000; margin: 0; padding: 0; border: 0;" bgcolor="#ffffff">
            ...
            <tbody>
                ...
                <tr>
                        ...
                        <img class="img-fluid" width="450" height="200" src="https://www.latinedit.com/PayAgile/logo%20latinedit.png" alt="Some Image" style="height: auto; line-height: 100%; outline: none; text-decoration: none; width: 100%; max-width: 100%; border: 0 none;">
                    ...
                    <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 1px; border-top-color: #dddddd; border-top-style: solid; height: 1px; width: 100%; margin: 0;" align="left"></td>
                            ...
                            <p
                                style="line-height:
                                    ...
                                    16px; width: 100%;
                                    margin: 0;"
                                    align="left"><b>Cliente:</b>'.$formCliente['nombre'].'
                            ...
                            <p
                                ...
                                '.$formCliente['documentoIdentidad'].'
                            </p>
            ...
            <thead>
                <tr>
                            ...
                            <th class="col-12" align="left" valign="top" style="line-height: 24px; font-size: 16px; min-height: 1px; padding-right: 15px; padding-left: 15px; font-weight: normal; width: 100%; margin: 0;">
                                ...
                                <thead style="background: #f07315ab;">
                                    <tr>
                                        <th
                                            style="line-height: 24px;
                                                  font-size: 16px;
            ...
            <thead>
                <tr>
                        ...
                        <div class="text-center" style="" align="center"><b>www.latinedit.com</b></div>
    ...
    private function enviarCorreo($templateHtml,$para,$tituloCorreo){
        try {
            ...
            $mail->CharSet='UTF-8';
            $mail->isMail();
            $mail->setFrom(getenv("CORREO_PAGINA"),'LATINEDIT.COM');
            $mail->addReplyTo(getenv("CORREO_PAGINA"),'REMIXES & EDITS PARA DJS');
